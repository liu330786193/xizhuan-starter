...
import com.xizhuan.wx.common.util.xml.IntegerArrayConverter;
import com.xizhuan.wx.common.util.xml.LongArrayConverter;
...
public class WxCpXmlMessage implements Serializable {
  ...
  /**
   * 通讯录变更事件.
   * 请参考常量 com.xizhuan.wx.cp.constant.WxCpConsts.ContactChangeType
   */
